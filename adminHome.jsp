...
<title>KMIT</title>
<body>
<img src="Kmit_logo.jpg"  align="left"width="100" height="100">
<!--  <center><img src="dgi.png" width="100" height="100">-->
<center><h3>KESHAV MEMORIAL INSTITUTE OF TECHNOLOGY</h3></center> 
...
%>
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact KMIT'S Examination Branch.
Designed & Developed by Teleparadigm Networks Pvt.Ltd</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ KMIT</h5></center> 
  <hr class="new1">
<br>
</body>
</html>