...
try{
	...
	ResultSet rs=st.executeQuery("select * from student inner join result  where student.rollNo like '"+rollNo+"' and student.rollNo=result.rollNo");
	if(rs.next()){
%>
<img src="Kmit_logo.jpg"  align="left"width="150" height="150">
<center><h3>KESHAV MEMORIAL INSTITUTE OF TECHNOLOGY</h3>
...
<body>
  <table>
    ...
    <hr class="new1">
  <center><h6>Note: Any errors occur then contact KMIT'S Examination Branch.
Designed & Developed by Teleparadigm Networks Pvt.Ltd</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @KMIT</h6></center> 
  <hr class="new1">
</body>
